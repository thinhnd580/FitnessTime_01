...
@property (assign, nonatomic) NSUInteger currentQuantity;
...
- (void)viewDidLoad {
    ...
    [self.txtFieldQuantity addTarget:self action:@selector(textFieldDidChange) forControlEvents:UIControlEventEditingChanged];
    self.currentQuantity = 0;
    self.txtFieldQuantity.text = [NSString stringWithFormat:@"%d",self.currentQuantity];
}
